...
pyMWGCprogen is a Python package which performs orbit integrations to track the orbits of 170 Galactic globular clusters and the 11 classical Milky Way satellite galaxies backwards in time in a Milky-Way-plus-satellites potential including the response of the Milky Way to the infall of the Large Magellanic Cloud and the effect of dynamical friction on the satellites. [pyMWGCprogen](https://github.com/Blackholan/pyMWGCprogen) intensively use [galpy]([https://galpy.github.io/](https://www.galpy.org/)) for galactic dynamics.
